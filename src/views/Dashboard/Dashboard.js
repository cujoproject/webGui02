  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        ...
        <Row>
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary" onClick={this.toggleLarge}>
              <CardBlock className="card-body pb-0">
                ...
                <h4 className="mb-0">Location Manager</h4>
                <p>Freezers</p>
              </CardBlock>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-info">
              <CardBlock className="card-body pb-0">
                ...
                <h4 className="mb-0">Study Manager</h4>
                <p>Studies</p>
              </CardBlock>
              <div className="chart-wrapper px-3" style={{height:'70px'}}>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-warning">
              <CardBlock className="card-body pb-0">
                ...
                <h4 className="mb-0">Log Samples</h4>
                <p>Logging</p>
              </CardBlock>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-danger">
              <CardBlock className="card-body pb-0">
                ...
                <h4 className="mb-0">General  Search</h4>
                <p>Searching..</p>
              </CardBlock>
              <div className="chart-wrapper px-3" style={{height:'70px'}}>
